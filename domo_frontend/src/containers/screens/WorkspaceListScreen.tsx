...
export function WorkspaceListScreen({ user, onSelectWorkspace, onLogout, onGoToMatch }: WorkspaceListScreenProps) {
              ...
              DOMO
                    ...
                    <div className="flex items-center gap-4">
                        {onGoToMatch && (
                            <button
                                onClick={onGoToMatch}
                                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 rounded-xl transition-all shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40"
                            >
                                <UserSearch size={18} />
                                <span>팀원 찾기</span>
                            </button>
